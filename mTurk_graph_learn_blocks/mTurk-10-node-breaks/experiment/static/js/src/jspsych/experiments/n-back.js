...
/* ************************************ */
function evalAttentionChecks() { //eslint-disable-line no-unused-vars
    var check_percent = 1;
    if (run_attention_checks) { //eslint-disable-line no-undef
...
function make_n_back_experiment(mode) { //eslint-disable-line no-unused-vars
